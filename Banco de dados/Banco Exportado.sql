...
-- Copiando estrutura do banco de dados para ceos
CREATE DATABASE IF NOT EXISTS `ceos` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `ceos`;

-- Copiando estrutura para tabela ceos.controlador_solar
CREATE TABLE IF NOT EXISTS `controlador_solar` (
  `fabricante` tinytext DEFAULT NULL COMMENT 'Fabricante do controlador solar',
  `nome` tinytext DEFAULT NULL COMMENT 'Nome completo do equipamento',
  `id` tinyint(4) DEFAULT NULL,
  `voltagem nominal do sistema min` tinyint(4) DEFAULT NULL,
  `voltagem nominal do sistema max` tinyint(4) DEFAULT NULL,
  `corrente nominal de carga` tinyint(4) DEFAULT NULL COMMENT 'Em A',
  `corrente nominal de descarga` tinyint(4) DEFAULT NULL COMMENT 'Em A',
  `tensao entrada de bateria` tinytext DEFAULT NULL,
  `max. tensao de circuito aberto de painel` smallint(6) DEFAULT NULL COMMENT 'à temperatura mínima ambiente ',
  `max. potencia de entrada painel (12V)(24V)` tinytext DEFAULT NULL,
  `tensao de carregamento - equalizacao selada` decimal(5,2) DEFAULT NULL COMMENT 'Em V',
  `tensao de carregamento - equalizacao inundada` decimal(5,2) DEFAULT NULL COMMENT 'Em V',
  `tensao de carregamento - boost gel` decimal(5,2) DEFAULT NULL COMMENT 'Em V',
  `tensao de carregamento - boost selada` decimal(5,2) DEFAULT NULL,
  `tensao de carregamento - boost inundada` decimal(5,2) DEFAULT NULL,
  `tensao de carregamento - flutuacao` decimal(5,2) DEFAULT NULL,
  `tensao de reconexao por baixa voltagem` decimal(5,2) DEFAULT NULL,
  `tensao de desconexao por baixa tensao` decimal(5,2) DEFAULT NULL,
  `eficiencia de conversao de pico` decimal(5,2) DEFAULT NULL,
  `mppt precisao` decimal(5,2) DEFAULT NULL,
  `temperatura de trabalho` tinytext DEFAULT NULL,
  `grau de Protecao` tinytext DEFAULT NULL,
  `terminais de potencia` tinytext DEFAULT NULL,
  `peso` decimal(5,2) DEFAULT NULL COMMENT 'Em kg',
  `garantia` decimal(5,2) DEFAULT NULL,
  `interface de comunicacao` tinytext DEFAULT NULL,
  `modelo de bateria` tinytext DEFAULT NULL,
  `link` tinytext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Aqui ficarão todas as informações sobre os controladores solares\r\nobs: todas essas infomações se encontram nos datasheets dos controladores';

-- Exportação de dados foi desmarcado.

-- Copiando estrutura para tabela ceos.inversor_fotovoltaico
CREATE TABLE IF NOT EXISTS `inversor_fotovoltaico` (
  `fabricante` tinytext DEFAULT NULL,
  `nome` tinytext DEFAULT NULL,
  `id` tinyint(4) DEFAULT NULL,
  `potencia nominal` smallint(6) DEFAULT NULL COMMENT 'Em W',
  `maxima potencia AC` smallint(6) DEFAULT NULL COMMENT 'Em VA',
  `maxima potencia de entrada` mediumint(9) DEFAULT NULL COMMENT 'Em W',
  `maxima tensao de entrada DC` smallint(6) DEFAULT NULL COMMENT 'Em V',
  `MTTP faixa de tensao operacional` tinytext DEFAULT NULL,
  `minima tensao DC/startup` smallint(6) DEFAULT NULL COMMENT 'Em V',
  `numero de MTTP` tinyint(4) DEFAULT NULL,
  `maxima corrente de entrada` decimal(5,2) DEFAULT NULL COMMENT 'Em A',
  `string por entrada DC` tinyint(4) DEFAULT NULL,
  `numero de conjuntos de conectores DC` tinyint(4) DEFAULT NULL,
  `tipo de terminal DC` tinytext DEFAULT NULL,
  `corrente nominal da saida` decimal(5,2) DEFAULT NULL COMMENT 'Em A',
  `maxima corrente de saida` decimal(5,2) DEFAULT NULL COMMENT 'Em A',
  `tensao nominal da rede eletrica` tinytext DEFAULT NULL,
  `frequencia da rede` tinytext DEFAULT NULL,
  `faixa de tensao AC min` smallint(6) DEFAULT NULL COMMENT 'Em V',
  `faixa de tensao AC max` smallint(6) DEFAULT NULL COMMENT 'Em V',
  `THDi` tinyint(4) DEFAULT NULL COMMENT 'sempre <',
  `maxima eficiencia` decimal(5,2) DEFAULT NULL COMMENT 'em %',
  `MPPT precisao` decimal(5,2) DEFAULT NULL,
  `protecao de isolamento DC` tinytext DEFAULT NULL,
  `protecao polaridade reversa` tinytext DEFAULT NULL,
  `protecao de sobrecorrente CA` tinytext DEFAULT NULL,
  `protecao contra superaquecimento` tinytext DEFAULT NULL,
  `peso` decimal(5,2) DEFAULT NULL,
  `garantia` decimal(5,2) DEFAULT NULL,
  `interfaces de comunicacao` tinytext DEFAULT NULL,
  `link` tinytext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Aqui ficarão todas as informações sobre os Inversores fotovoltaicos\r\nobs: todas essas infomações se encontram nos datasheets dos inversores';

-- Exportação de dados foi desmarcado.

-- Copiando estrutura para tabela ceos.placa_solar
CREATE TABLE IF NOT EXISTS `placa_solar` (
  `fabricante` tinytext DEFAULT NULL,
  `nome` tinytext DEFAULT NULL,
  `id` tinyint(4) DEFAULT NULL,
  `potencia nominal max` smallint(6) DEFAULT NULL COMMENT '(Pmax) em W',
  `tensao operacional opt` decimal(5,2) DEFAULT NULL COMMENT '(Vmp) em V',
  `corrente operacional opt` decimal(5,2) DEFAULT NULL COMMENT '(Imp) em A',
  `eficiencia do modulo` decimal(5,2) DEFAULT NULL,
  `temperatura operacional` tinytext DEFAULT NULL,
  `tensao do sistema max` smallint(6) DEFAULT NULL,
  `protecao contra incendio` tinytext DEFAULT NULL,
  `classificacao da aplicacao` tinytext DEFAULT NULL,
  `tipo de celula` tinytext DEFAULT NULL,
  `peso` decimal(5,2) DEFAULT NULL COMMENT 'Peso da placa em kg',
  `coeficiente de temperatura (Pmax)` decimal(3,3) DEFAULT NULL,
  `coeficiente de temperatura (Voc)` decimal(3,3) DEFAULT NULL,
  `coeficiente de temperatura (Isc)` decimal(4,4) DEFAULT NULL,
  `garantia` decimal(5,2) DEFAULT NULL COMMENT 'Em Anos',
  `corrente maxima de fusivel` decimal(5,2) DEFAULT NULL,
  `link` tinytext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Aqui ficarão todas as informações sobre os Paineis fotovoltaicos\r\nobs: todas essas infomações se encontram nos datasheets das placas';
...
-- Copiando estrutura para tabela information_schema.THREAD_POOL_GROUPS
...
-- Copiando estrutura para tabela information_schema.THREAD_POOL_QUEUES
...
-- Copiando estrutura para tabela information_schema.THREAD_POOL_STATS
...
-- Copiando estrutura para tabela information_schema.THREAD_POOL_WAITS
...
-- Copiando estrutura para tabela mysql.global_priv
...
-- Copiando estrutura para tabela mysql.transaction_registry
...
-- Copiando estrutura para view mysql.user
